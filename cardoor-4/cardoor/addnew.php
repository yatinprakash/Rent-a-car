                ...
                <div class="col-lg-4 col-md-8 m-auto">
                	<div class="login-page-content">
                		<div class="add-car-form">
                          ...
                          <div class="car name">
                              <input type="text" placeholder="Car Name" name="nameid" id="nameid">
                          </div>
                                <div class="car type">
                                    <input type="text" placeholder="Car Type" name="typeid" id="typeid">
                                </div>
                                <div class="cost">
                                    <input type="text" placeholder="Price" name="cost" id="cost">
                                </div>
                                <div class="seat-cap">
                                    <input type="text" placeholder="Seating Capacity" name="seat cap" id="seat cap">
                                </div>
                                <div class="images">
