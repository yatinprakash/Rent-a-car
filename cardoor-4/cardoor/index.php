                                ...
                                if(isset($_SESSION['sess_name']))
                                  {
                                    ...
                                    echo "<li><a href=myaccountash.php>My Account</a></li>";
                        ...
                        <div class="book-a-car">
                            <form action="booking2.php" method="GET" >
                                ...
                                <div class="pick-up-date book-item">
                                    <h4>PICK-UP DATE:</h4>
                                    <input type="date" id="startDate" placeholder="Pick Up Date" name="sdate" id="sdate" />

                                    <div class="return-car">
                                        <h4>Return DATE:</h4>
                                        <input type="date" id="endDate" placeholder="Return Date" name="edate" id="edate"  />
                                    </div>
                                </div>
                                <!--== Pick Up Location ==-->
                                ...
                                <div class="choose-car-type book-item">
                                    ...
                                    <select class="custom-select" name="ctype" id="ctype">
                                      <option selected>Select</option>
