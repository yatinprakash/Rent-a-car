            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title  text-center">
                        ...
                        <p>Find your upcoming booking.</p>
                    </div>
                </div>
                <!-- Page Title End -->
            </div>
                                                                    ...
                                                                    <div class="display-table">
                                                                        <div class="display-table-cell">
                                                                            <div class="car-list-info">
                                                                                  <a href="sedan.php" class="rent-btn">Sedan</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                              ...
                                                              <div class="row">
                                                                  ...
                                                                  <div class="col-lg-4">
                                                                      <div class="display-table">
                                                                          <div class="display-table-cell">
                                                                              <div class="car-list-info">
                                                                                    <a href="#" class="rent-btn">Economy</a>
                                                                              </div>
                                                                          </div>
                                                                      </div>
                                                                  </div>
                                                        ...
                                                        <div class="car-list-content">
                                                            ...
                                                            <div class="single-car-wrap">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="car-list-thumb car-thumb-1"></div>
                                                                          <a href="#" class="rent-btn">Premium</a>
                                                                    </div>
                                                                    <!-- Single Car Info -->
