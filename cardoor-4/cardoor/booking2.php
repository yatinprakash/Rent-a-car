                        ...
                        elseif(isset($_GET['searchbutton']))
                        {
                          ...
                          $query = $_GET['query'];
                            ...
                            echo $innerText;
                                  ...
                                  $sql = "select car.* from car where car.type_id=$ctype and car.car_id in (select DISTINCT car_loc.car_id from car_loc where car_loc.loc_id = $location and car_loc.car_id not in (select car_id from booking where not (('$sdate' > return_date and '$edate' > return_date) or ('$sdate' < pick_up and '$edate' < pick_up))))";
                                    echo $sql;
